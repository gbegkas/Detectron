...
dataDir = '/home/vegas/data/Databases/CBIS-DDSM/Test'
annFile = '/home/vegas/data/Databases/CBIS-DDSM/Test/instances_shape_val2018.json'
...
for imgId in imgIds:
    ...
    # plt.imshow(I)
    # plt.show()
    cv2.imwrite(os.path.join(destDir, img['file_name']), I)
